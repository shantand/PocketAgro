...
public class WiFiDirectActivity extends Activity implements ChannelListener, DeviceActionListener, Replication.ChangeListener {

    public static final String TAG = "AgroCouch";
    ...
    public static final String defaultDatabaseUrl = "http://192.168.49.1:5984/agrodb_no_nid";
    protected LiteListener listen;
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       listen = new LiteListener(manager1, 5984);
       listen.start();
        ...
        //start CBLlistener
		 ...
		 //((TextView)findViewById(R.id.status_text)).setText("CouchDB server listening on port 5984");
    ...
    //Creating methods for starting cbllistener
      protected void startCBLite() throws Exception {

        manager1 = new Manager(Environment.getExternalStorageDirectory(), Manager.DEFAULT_OPTIONS);
              
        
        
        //install a view definition needed by the application
        database = manager1.getExistingDatabase(DATABASE_NAME);
